...
func main() {
	...
	err = db.QueryRow("INSERT INTO userinfo(username,department,created) VALUES($1,$2,$3) returning uid;", "kaywall", "研发部门", "2019-10-31").Scan(&lastInsertId)
	checkErr(err)
	...
	res, err = stmt.Exec("kaywall_new", 1)
	checkErr(err)
